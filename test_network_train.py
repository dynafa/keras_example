...
sdg = keras.optimizers.SGD(learning_rate=0.01, momentum=0.5, decay=1e-2, nesterov=False)

# Define a simple sequential model
def create_model():
    mymodel = tf.keras.models.Sequential([
        keras.layers.Flatten(input_shape=(dims_X * dims_X, 3)),
